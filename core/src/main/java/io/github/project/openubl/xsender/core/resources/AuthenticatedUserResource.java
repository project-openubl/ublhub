...
public interface AuthenticatedUserResource {
    ...
    /**
     * Get current user and init User Organization
     */
    @GET
    @Path("/")
    String initUser();
    ...
    @GET
    @Path("/orgs")
    PageRepresentation<OrganizationRepresentation> getCurrentUserOrganizations(
    ...
    @POST
    @Path("/repos")
    RepositoryRepresentation createRepository();
}
