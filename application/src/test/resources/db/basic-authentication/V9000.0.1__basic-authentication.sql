insert into APP_USER(id, full_name, username, password, permissions, version)
values (nextval('hibernate_sequence'), 'Carlos Feria', 'admin',
       ...
       (nextval('hibernate_sequence'), 'Alice Smith', 'alice',
        '$2a$10$kycqeNLdoIhDgn5oegz.ie1QsUWD5l0cCb.4.0iDKp9x1NUjrwyAG', 'project:read,project:write', 1);
