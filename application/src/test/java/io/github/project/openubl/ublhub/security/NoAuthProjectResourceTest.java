...
@QuarkusTest
@TestProfile(NoAuthProjectResourceTest.Profile.class)
@TestHTTPEndpoint(ProjectResource.class)
public class NoAuthProjectResourceTest extends AbstractBaseTest {

    public static class Profile implements QuarkusTestProfile {
        @Override
        public Map<String, String> getConfigOverrides() {
            return Map.of("openubl.auth.enabled", "false");
        }
    }
