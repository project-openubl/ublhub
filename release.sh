...
git push "https://$username:$password@github.com/project-openubl/xml-sender.git"

# Create tag and push
git tag "$releaseVersion"
git push "https://$username:$password@github.com/project-openubl/xml-sender.git" --tags
