...
git push "https://$username:$password@github.com/project-openubl/xsender-server.git"

# Create tag and push
git tag "$releaseVersion"
git push "https://$username:$password@github.com/project-openubl/xsender-server.git" --tags
