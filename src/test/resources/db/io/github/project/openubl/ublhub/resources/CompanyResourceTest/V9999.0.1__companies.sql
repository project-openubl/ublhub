-- NAMESPACES
insert into namespace(id, name, description, created_on, version)
values ('1', 'my-namespace1', 'description1', CURRENT_TIMESTAMP + INTERVAL '1 day', 1),
       ('2', 'my-namespace2', 'description2', CURRENT_TIMESTAMP + INTERVAL '2 day', 1),
       ('3', 'my-namespace3', 'description3', CURRENT_TIMESTAMP + INTERVAL '3 day', 1);
