...
-- COMPANIES
insert into company(id, ruc, name, namespace_id, sunat_username, sunat_password, sunat_url_factura, sunat_url_guia_remision, sunat_url_percepcion_retencion, created, version)
values
-- Companies in namespace 1
('11', '11111111111', 'company1', '1', 'username1', 'password1', 'http://urlFactura1', 'http://urlGuia1', 'http://urlPercepcionRetencion1', CURRENT_TIMESTAMP + INTERVAL '1 day', 1),
('22', '12345678912', 'company2', '1', '12345678912MODDATOS', 'MODDATOS', 'https://e-beta.sunat.gob.pe/ol-ti-itcpfegem-beta/billService', 'https://e-beta.sunat.gob.pe/ol-ti-itemision-guia-gem-beta/billService', 'https://e-beta.sunat.gob.pe/ol-ti-itemision-otroscpe-gem-beta/billService', CURRENT_TIMESTAMP + INTERVAL '2 day', 1),
-- Companies in namespace 2
('33', '11111111111', 'company3', '2', 'username3', 'password3', 'http://urlFactura3', 'http://urlGuia3', 'http://urlPercepcionRetencion3', CURRENT_TIMESTAMP + INTERVAL '3 day', 1),
