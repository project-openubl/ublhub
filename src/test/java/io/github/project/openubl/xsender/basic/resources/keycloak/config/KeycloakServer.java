 ...
 */
package io.github.project.openubl.xsender.basic.resources.keycloak.config;
...
public class KeycloakServer implements QuarkusTestResourceLifecycleManager {
    ...
    public Map<String, String> start() {
        keycloak = new FixedHostPortGenericContainer("quay.io/keycloak/keycloak:" + System.getProperty("keycloak.version", "11.0.2"))
