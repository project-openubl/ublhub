...
import { FilterIcon, BuildingIcon, InfoAltIcon,CheckCircleIcon, InfrastructureIcon } from "@patternfly/react-icons";
...
const Companies: React.FC = () => {
  ...
  const modal = useModal<"ADD", CompanyDto>();
          ...
          <ToolbarContent>
            ...
            <ToolbarGroup variant="button-group">
              <ToolbarItem>
                ...
                >
                  {t("actions.create-object", { what: t("terms.company") })}
                </Button>
              </ToolbarItem>
            </ToolbarGroup>
          </ToolbarContent>
          ...
          then={
            <Bullseye>
              <EmptyState>
                ...
                <EmptyStateBody>No hay empresas registradas</EmptyStateBody>
              </EmptyState>
            </Bullseye>
          }
        >
          <DataList aria-label="Companies list">
            {filteredItems.map((item) => (
              <DataListItem key={item.ruc} isExpanded={isRowExpanded(item)}>
                <DataListItemRow>
                  <DataListToggle
                    id="expanded"
                  ...
                  >
                    <Dropdown
                      ...
                      // onSelect={() => toggleItemSelected(item)}
                      toggle={
                        <KebabToggle
                ...
                <DataListContent
                  ...
                  isHidden={!isRowExpanded(item)}
                  hasNoPadding
                >
                  {project && (
                    <CompanyDetailsTabs project={project} company={item} />
                  )}
                </DataListContent>
              </DataListItem>
            ))}
