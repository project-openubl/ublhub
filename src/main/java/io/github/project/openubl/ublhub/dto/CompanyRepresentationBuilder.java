...
public final class CompanyRepresentationBuilder {
    ...
    public CompanyRepresentationBuilder withWebServices(SunatWebServicesDto webServices) {
        this.webServices = webServices;
        return this;
    }

    public CompanyRepresentationBuilder withCredentials(SunatCredentialsDto credentials) {
