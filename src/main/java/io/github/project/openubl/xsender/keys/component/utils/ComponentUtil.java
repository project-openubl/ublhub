...
public interface ComponentUtil {
    ...
    default void notifyCreated(String entityId, ComponentModel model) {
        ComponentFactory factory = getComponentFactory(model);
        factory.onCreate(entityId, model);
    }

    default void notifyUpdated(String entityId, ComponentModel model) {
        ComponentFactory factory = getComponentFactory(model);
        factory.onUpdate(entityId, model);
    }
